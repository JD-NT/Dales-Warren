                ...
                <div className="intro-layout halftone-bg">
                    ...
                    <div className='intro-content4'>
                        <div className='additional-content'>
                            <span><small>Utilitarian design is an art concept that argues for the products to be designed based on the utility.</small></span>
                            <span><small>Brutalism is a style with an emphasis on producing highly imposing, bold, and expressive forms that go against the norm.</small></span>
                    ...
                    <div className="intro-content2 profile-box bounding-box-L">
                            ...
                            <div className='social-box'>
                                <a className='social-link' href='mailto:bruh.itsbonkers0609@gmail.com' target='_blank'><Image src='/assets/icons/gmail.webp' draggable='false' className='icon' width={16} height={16} alt=''/><p>Email</p></a>
